 ...
 *
 * Browser half of dsh-approval-bash-highlight: the `client.js` body wrapped in the
...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const styles = {
			insert(css) {
				const tagId = "dsh-approval-bash-highlight/client.js";
				if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
					const tag = document.createElement("style");
					tag.dataset.plugin = "dsh-approval-bash-highlight";
